...
class Workout {
  ...
  void exportToCsv() {
    ...
    String prefix =
        '$trainingName,${Converter.convertDateTimeToString(startTime)},${Converter.convertDateTimeToString(endTime)},';
    List<String> result = [];
    ...
    return (Container(
      child: Column(
        children: [
          Text(trainingName),
          ListView(
            children: [... excercises.map((e) => e.toWidget())],
          )
      ],) 
